...
<div class="
  bg-base-100 text-base-content fixed top-0 z-30 flex h-16 w-full justify-center bg-opacity-50 backdrop-blur transition-shadow duration-100 [transform:translate3d(0,0,0)]
  shadow-sm
  ">
    <div class="navbar max-w-3xl mx-auto justify-between">
        <div class="w-full text-center justify-center">
            <a href="/" class="btn btn-ghost text-2xl bg-gradient-to-r from-blue-500 via-teal-300 to-indigo-600 bg-clip-text text-transparent">StudyHaven</a>
        </div>
        <div class="w-full text-center justify-center">
